...
export const generateWAMessageContent = async (
	...
	// Compatibility helpers for legacy Baileys-style buttons, templates, lists and native-flow interactive messages.
	if (hasOptionalProperty(message, 'buttons') && !!message.buttons) {
		...
		m = {
			templateMessage: {
				fourRowTemplate: hydratedTemplate as any,
				hydratedTemplate,
	...
	if (hasOptionalProperty(message, 'interactiveButtons') && !!message.interactiveButtons) {
		...
		if (hasOptionalProperty(message, 'title') && !!message.title) {
			...
			if (!hasOptionalProperty(message, 'text') && !hasOptionalProperty(message, 'caption')) {
				Object.assign(interactiveMessage.header, m)
			}
		}
